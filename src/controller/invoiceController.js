...
//         doc.setFontSize(12);
//         doc.setFont('Roboto', 'bold');
//         doc.text("Thông tin phòng đặt:", 10, 70);
//         doc.setFontSize(13);
//         doc.setFont('Roboto', 'normal');
...
//         const shortCode = code.substring(0, 8); // Lấy 8 ký tự đầu từ mã đặt phòng
...
//         res.send('In hoá đơn thành công!');
//     } catch (error) {
//         console.error(error);
...
//                     attributes: [] // Exclude attributes, just join for the sum calculation
//                 }
//             ],
//             attributes: [
//                 [Sequelize.fn('MONTH', Sequelize.col('createdAt')), 'month'],
//                 [Sequelize.fn('SUM', Sequelize.literal('Booking.total_price + Booking_service.total_price')), 'totalRevenue']
//             ],
//             where: {
